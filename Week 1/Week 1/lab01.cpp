...
*    James Olney
* Summary:
*     A program to prompt the user for an integer. If the provided number is not zero,
* then him/her is prompted for another integer. This continues until the user is worn
* down and he/she enters '0'. At this point, the program will display how many
